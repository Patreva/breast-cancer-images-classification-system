...
predict(){
    this.loading = true
    this.disabled = false
    this.axios.post('/api/classifyidcimages')
        .then(data => {
            this.loading = false
            this.$store.state.idcsystemprediction = data.data.systemprediction;
            this.$store.state.idcpredictiondetail = data.data.predictiondetail;
            this.$router.push('/idcfeedback');
        }).catch(function(data) {
            this.loading = false
...
submitFiles() {
    this.loading = true 
        ...
        this.axios.post('/api/uploadidcimages',formData)
        .then(() => {
